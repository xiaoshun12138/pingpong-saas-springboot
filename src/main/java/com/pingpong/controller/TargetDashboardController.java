...
public class TargetDashboardController {
    ...
    public R<TargetDashboardVO> salesTargetDashboard(
        ...
        return R.ok(targetDashboardService.salesTargetDashboard(year, filterStoreId));
    }
    ...
    public R<TargetDashboardVO> consumptionTargetDashboard(
        ...
        return R.ok(targetDashboardService.consumptionTargetDashboard(year, filterStoreId));
    }
}
